...
export const projects = [
  {
    slug: "mood-master",
    title: "Mood Master — iOS Mental Health App",
    image: "/images/moodmaster.png", 
    tags: ["Swift", "iOS", "AVFoundation", "Firebase", "Firestore", "URLSession", "Keychain", "XCTest"],
    desc:
    ...
    architecture: [
      "Swift app; AVFoundation for voice recording/playback.",
      "Firebase Firestore + Storage for data/media; Auth for sessions.",
      "Offline caching with conflict-aware merge; URLSession for networking.",
      "Keychain for secure credentials; structured error handling & retry/backoff."
    ],
    decisions: [
      "Chose Firebase to accelerate secure, scalable data & media storage.",
      "Used AVFoundation for precise audio control on iOS.",
...

  {
    ...
    long:
      "Built a map-centric UX with Leaflet (custom markers & bounds sync), an Explore page that reads OSM/Overpass data, and a Care section for tips. Added smooth interactions with Framer Motion, deep links for opening in native maps with place names, and mobile-first accessibility.",
